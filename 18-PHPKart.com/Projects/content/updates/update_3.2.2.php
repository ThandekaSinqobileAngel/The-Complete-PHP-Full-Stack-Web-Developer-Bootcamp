<?php
  ...
  add_column_if_not_exist($table_prefix.'products','file_name','VARCHAR(250) NOT NULL');
 ...
 if($rs){
   execute("update ".$table_prefix."version set version = '3.2.2'");
 }else{
   execute("insert into ".$table_prefix."version (version) values ('3.2.2')");
 }
